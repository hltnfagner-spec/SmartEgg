-- ========================================
-- CORREÇÃO FINAL - Views não suportam políticas RLS
-- Solução: Usar função ao invés de view
-- ========================================
...
-- 4. Criar políticas com nomes únicos
CREATE POLICY "admin_users_public_read"
  ON admin_users FOR SELECT
  USING (true);

CREATE POLICY "subscriptions_owner_and_admin_read"
...
CREATE POLICY "subscriptions_owner_and_admin_update"
...
CREATE POLICY "company_settings_owner_and_admin_read"
...
-- 5. Criar VIEW sem política RLS (views herdam permissões das tabelas base)
...
-- 10. Testar se users_view funciona
SELECT COUNT(*) as "Total Users" FROM public.users_view;

-- 11. Listar políticas criadas
SELECT 
  schemaname,
  tablename,
  policyname,
