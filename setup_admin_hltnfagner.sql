-- Script para tornar hltnfagner@gmail.com administrador
...
-- 7. Ativar assinaturas por 365 dias (1 ano) para ambas as contas
...
SET 
  ...
  updated_at = NOW()
WHERE user_id IN (
  SELECT id FROM auth.users WHERE email IN ('hltnfagner@gmail.com', 'hiltonfag@gmail.com')
);

-- 8. Verificar assinaturas
SELECT 
  u.email,
